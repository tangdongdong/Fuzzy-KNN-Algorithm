 ...
 * This Class implement classification and  prediction of Classical KNN (k=68) algorithm on ClaMP dataset.
 */
public class ClaMPClassicalKNN {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Benign Dada Set Size: " + benignInstances.size() + " , " + "Malicious Dada Set Size: " + maliciousInstances.size());

            String resultFile = "../..../Result/ClaMP/Classical_KNN_ClaMP_Result(k=68).csv";
            ...
            for (int i = 0; i < fold; i++) {
                ...
                // n_neighbor = 68
                Classifier IBkClassifier = new IBk(68);
                ...
                for (int j = 0; j < sizeOfTestSet; j++) {
                    ...
                    int predictLabel = (int) IBkClassifier.classifyInstance(testInstances.instance(j));
