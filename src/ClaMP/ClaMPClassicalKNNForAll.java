 ...
 * This class is used to get the performance (including mean Accuracy and mean LogLoss) of Classical KNN classifier under all legal 'k' (1-4465) on ClaMP data set.
 */
